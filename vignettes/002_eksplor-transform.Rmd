...
3. (mutate) mengubah nilai dari kolom month yang semula angka menjajdii nama bulan
4. (group_by) melakukan grouping berdasarkan kolom month
5. (summarise) menghitung rerata kecepatan angin dan rerata tekana udara
